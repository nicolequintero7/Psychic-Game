...
var updateGuessesLeft = function() {
 ...
 document.querySelector("#User-Guesses-Left").innerHTML = guessesLeft;
//  $("#guesses-left").append(guessesLeft);
//   $(guessesLeft).append("#guesses-left");
};
...
var updateGuessesSoFar = function() {
  ...
  document.querySelector("#User-Guesses-So-Far").innerHTML = guessedLetters.join(", ");
};
